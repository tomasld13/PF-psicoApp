...
const LandingPsico = () => {
    return (
        <div className="text-white">
          <img src={background} alt='' className=' absolute  -z-10 brightness-500 blur-md' />
          <div className='max-w-[800px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center'>
            ...
            <button className='bg-[#575989] w-[200px] rounded-md font-medium my-6 mx-auto py-3'> <a href='/auth/login'>Comenzar ahora</a> </button>
          </div>
        </div>
      );
};
