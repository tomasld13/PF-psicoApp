  ...
  <div name='support' className='w-full mt-24 bg-darkgray mb-12'>
      ...
      <div className='max-w-[1240px] mx-auto text-white relative'>
          ...
          <div className='grid grid-cols-1 lg:grid-cols-3 relative gap-x-8 gap-y-16 px-4 pt-12 sm:pt-20 text-black'>
              <div className='bg-secundary rounded-xl shadow-2xl'>
                  <div className='p-8 bg-secundary'>
                      <AiOutlinePhone className='w-16 bg-indigo-600 text-black rounded-lg h-16  mt-[-4rem]' />
                      <h3 className='font-bold text-2xl my-6 text-black'>Clientes</h3>
                      <p className='text-black text-xl text-start'>Con más de 3000 pacientes mensuales, hay oportunidades de sobra para usted! Te brindamos las siguientes herramientas:
              ...
              <div className='bg-secundary rounded-xl shadow-2xl'>
                  <div className='p-8'>
                      <FcCustomerSupport className='w-16 bg-indigo-600 text-black rounded-lg h-16  mt-[-4rem]' />
                      <h3 className='font-bold text-2xl my-6 text-black'>Soporte técnico</h3>
                      <p className='text-black text-xl text-start'>Ante cualquier inconveniente, brindamos soporte las 24 hs. Podes contactarnos vía telefono o correo electrónico.
              ...
              <div className='bg-secundary rounded-xl shadow-2xl'>
                  <div className='p-8'>
                      <FcMoneyTransfer className='w-16 bg-indigo-600 text-black rounded-lg h-16  mt-[-4rem]' />
                      <h3 className='font-bold text-2xl my-6 text-black'>Cobros y pagos</h3>
                      <p className='text-black text-xl text-start'>Los pagos se realizan directamente entre el cliente y la cuenta del profesional. El costo de los servicios de la página es un único pago mensual que se mantiene en un 
