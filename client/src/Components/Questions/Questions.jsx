  ...
  return (
    <div className={style.content} name='questions' >
      ...
      <SectionTitle subheading='Preguntas Frecuentes' heading='' />
        ...
        descQuestion={"Los psicólogos son profesionales que estudian la mente humana, las emociones y el comportamiento. Pueden ayudarlo en varios aspectos de su vida, como carrera, relaciones, salud."}/><hr/>

        <Question nameQuestion="¿Cual es la duración de una sesión?" 
        descQuestion={`La duración de una sesión es de 50 minutos.`}/><hr/>
        ...
        descQuestion={`Si necesita cancelar su cita, informe al representante de servicio al cliente.`}/><hr/>

        <Question nameQuestion="¿Qué métodos de pago aceptan?" 
        descQuestion={`Aceptamos pagos mediante tarjeta de crédito, transferencia bancaria y Mercadopago. `}/><hr/>
